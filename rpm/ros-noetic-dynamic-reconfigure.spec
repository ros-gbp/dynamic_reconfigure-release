...
BuildRequires:  ros-noetic-catkin >= 0.5.87
...
%description
The dynamic_reconfigure package provides a means to update parameters at runtime
without having to restart the node.
...
%changelog
* Fri Aug 28 2020 Michael Carroll <michael@openrobotics.org> - 1.7.1-1
- Autogenerated by Bloom

* Thu Mar 05 2020 Michael Carroll <michael@openrobotics.org> - 1.7.0-1
- Autogenerated by Bloom
